...
Invoke the planner agent to produce a phased rollout plan. This overrides the planner's default-to-immediate-change directive: the user has explicitly asked to ship the change in phases.
